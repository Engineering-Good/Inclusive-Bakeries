const sampleRecipes = [
  ...
  },
  {
    ...
    ingredients: [
      { id: '3001', name: 'FullCreamMilk', amount: 225, unit: 'g' },
      { id: '3002', name: 'Eggs', amount: 2, unit: '' },
      { id: '3003', name: 'Oil', amount: 50, unit: 'g' },
      { id: '3004', name: 'Sugar', amount: 80, unit: 'g' },
      { id: '3005', name: 'Flour', amount: 130, unit: 'g' },
      { id: '3006', name: 'CocoaPowder', amount: 15, unit: 'g' },
      { id: '3007', name: 'BakingPowder', amount: 12, unit: 'g' },
      { id: '3008', name: 'Salt', amount: 0.5, unit: 'tsp' },
      { id: '3009', name: 'ChocolateChips', amount: 75, unit: 'g'}
    ],
